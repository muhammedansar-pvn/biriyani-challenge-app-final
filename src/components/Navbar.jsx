        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-6">
              <a href="#home" className="text-slate-700 hover:text-brand-lime transition-colors px-2 py-1 rounded-md text-xs sm:text-sm font-extrabold">Home</a>
              <button 
              ...
              <a href="#order" className="bg-brand-lime text-white hover:bg-brand-yellow transition-all px-5 py-2 rounded-full text-xs sm:text-sm font-extrabold flex items-center gap-1.5 shadow-md shadow-brand-lime/15 cursor-pointer">
                Order Now
              </a>
            </div>
          </div>
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-1.5 rounded-xl text-slate-600 hover:text-brand-lime hover:bg-green-50 transition-all focus:outline-none"
            >
